...
type
  ...
  private
    ...
    fBackgroundDefault: TAlphaColor;
    fForeground: TAlphaColor;
    fForegroundDefault: TAlphaColor;
    ...
    procedure SetBackground(Value: TAlphaColor);
    procedure SetForeground(Value: TAlphaColor);
...
{$ENDIF}
  public
    procedure SetColors(Foreground, Background: TAlphaColor);
  ...
  published
    property Background: TAlphaColor read fBackground write SetBackground stored GetBackgroundColorStored;
    property Foreground: TAlphaColor read fForeground write SetForeground stored GetForegroundColorStored;
...
{$IFNDEF SYN_CPPB_1}
  ...
  public
    ...
    property Items[Index: Integer]: TSynCustomHighlighterClass read GetItem; default;
  end;
...
begin
  inherited Create;
  Background := TAlphaColorRec.Null;
  Foreground := TAlphaColorRec.Null;
  fName := AName;
...
const
  Pal16: array [0 .. 15] of TAlphaColor = (
    TAlphaColorRec.Black,
    TAlphaColorRec.Maroon,
    TAlphaColorRec.Green,
    TAlphaColorRec.Olive,
    TAlphaColorRec.Navy,
    TAlphaColorRec.Purple,
    TAlphaColorRec.Teal,
    TAlphaColorRec.LtGray,
    TAlphaColorRec.DkGray,
    TAlphaColorRec.Red,
    TAlphaColorRec.Lime,
...
procedure TSynHighlighterAttributes.SetBackground(Value: TAlphaColor);
begin
...
procedure TSynHighlighterAttributes.SetColors(Foreground, Background: TAlphaColor);
begin
...
procedure TSynHighlighterAttributes.SetForeground(Value: TAlphaColor);
begin
