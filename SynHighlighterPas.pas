...
begin
  ...
  fDirecAttri.Style := [TFontStyle.fsItalic];
...
procedure TSynPasSyn.SetDelphiColors;
begin
  // asm: default

  fCommentAttri.Foreground := TAlphaColorRec.Green;
  fCommentAttri.Style := [TFontStyle.fsItalic];

  fDirecAttri.Foreground := TAlphaColorRec.Teal;

  // identifier: default

  fKeyAttri.Foreground := TAlphaColorRec.Navy;

  fNumberAttri.Foreground := TAlphaColorRec.Blue;
  fFloatAttri.Foreground := TAlphaColorRec.Blue;
  fHexAttri.Foreground := TAlphaColorRec.Blue;

  // space: default

  fStringAttri.Foreground := TAlphaColorRec.Blue;

  fCharAttri.Foreground := TAlphaColorRec.Blue;
